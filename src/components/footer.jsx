	...
	return (
		<>
			<footer className=' bg-green-900 text-green-100'>
				<div className='sm:flex-row flex-col gap-x-16 gap-y-10 text-sm flex w-full place-items-start p-10 max-w-[1200px] m-auto'>
				...
				<div className='sm:grid-flow-row grid-flow-column  gap-x-4  text-sm grid w-full place-items-start px-10  py-4 border-t max-w-[1200px] m-auto border-green-600'>
